...
public class MediumPig extends Sprite implements InputProcessor {
    ...
    public void update(float dt) {
        ...
        if (currentState != MediumPig.State.DAID) {
            ...
            Timer.schedule(new Timer.Task() {
                @Override
                public void run() {
                    ControllerLogic.MediumcircleArray.removeValue(MediumPig.this, false);
                    streach.play();
                }
            }, 0.2f);
        }
    ...
    public boolean isDestroyed() {
        return currentState == MediumPig.State.DAID;
    }
    ...
    public static int getMediumCircleArrayLength() {
        return ControllerLogic.MediumcircleArray.size;
    }
