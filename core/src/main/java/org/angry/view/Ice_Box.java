...
public class Ice_Box extends Sprite implements InputProcessor {
    private World world;
    private Body body;
    ...
    public Ice_Box(World world, Rectangle rectangle,float df,float sf) {
        super(new Texture("ice_rectangle.png"));
        ...
        if (rectangle.getWidth() > rectangle.getHeight()) {
            textureRegion = new TextureRegion(getTexture(), 0, 0, 1265, 150);
        } else {
            textureRegion = new TextureRegion(getTexture(), 0, 0, 1265, 283);
        }
